...
synopsis: Find out how to override the configuration of your Quarkus app from its test code.
author: gwenneg
---
...
In addition to the config override, they provide https://quarkus.io/guides/getting-started-testing#writing-a-profile[many additional capabilities^] which help control
