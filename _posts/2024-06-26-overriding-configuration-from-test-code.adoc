...
Therefore, the `application.properties` file doesn't qualify as a valid approach to override the configuration of a Quarkus app from the test code.
...
In this post, we discussed several approaches to override the configuration of a Quarkus app from its test code.
